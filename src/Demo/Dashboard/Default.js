...
class Dashboard extends React.Component {
    render() {
        ...
        return (
                ...
                <Row>
                <Col md={12} xl={12}>
                    <h6 className='mb-4 f-w-600 text-c-red'>REQUESTS MADE</h6>
                </Col>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Today</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-8">
                                        <h4 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> &#8358;110,000</h4>
                                    </div>

                                    <div className="col-4 text-right">
                                        <p className="m-b-0"><i className="feather icon-box f-22 text-c-green"/>26</p>
                                    </div>
                                </div>
                    ...
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Month-Till-Date</h6>
                                <div className="row d-flex align-items-center">
                                    <div className="col-8">
                                        <h4 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> &#8358;2,942,050</h4>
                                    </div>

                                    <div className="col-4 text-right">
                                        <p className="m-b-0"><i className="feather icon-box f-22 text-c-green"/>136</p>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-4 text-right">
                                        <p className="m-b-0"><i className="feather icon-box f-22 text-c-green"/>670</p>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                    ...
                    <Col md={12} xl={12}>
                        <h6 className='mb-4 f-w-600 text-c-red'>DELIVERIES DONE</h6>
                    </Col>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-4 text-right">
                                        <p className="m-b-0"><i className="feather icon-wind f-22 text-c-green"/>26</p>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                                    <div className="progress-bar progress-c-theme" role="progressbar" style={{width: '100%'}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"/>
                        ...
                        <Card>
                            <Card.Body>
                                ...
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col-4 text-right">
                                        <p className="m-b-0"><i className="feather icon-wind f-22 text-c-green"/>136</p>
                                    </div>
                                </div>
                                <div className="progress m-t-30" style={{height: '7px'}}>
                                    <div className="progress-bar progress-c-theme2" role="progressbar" style={{width: '100%'}} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"/>
                        ...
                        <Card className='card-event'>
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <h6 className="m-0">Pending Recoveries</h6>
                                    </div>
                                    {/* <div className="col-auto">
                                        <label className="label theme-bg2 text-white f-14 f-w-400 float-right">34%</label>
                                    </div> */}
                                </div>
                                <h2 className="mt-2 f-w-300">45<sub className="text-muted f-14">Recoveries</sub></h2>
                                {/* <h6 className="text-muted mt-3 mb-0">You can participate in event </h6> */}
                                <a href={DEMO.BLANK_LINK} className="label theme-bg2 text-white f-12">View All Recoveries</a>
                            ...
                            <Card.Body className='border-bottom'>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col">
                                        ...
                                        <span className="d-block text-uppercase">total Senders</span>
                                    </div>
                                </div>
                            </Card.Body>
                            <Card.Body>
