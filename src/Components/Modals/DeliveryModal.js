...
class DeliveryModal extends PureComponent {
    ...
    toggle = () => {
        ...
        if (!this.state.modal) {
            this.props.fetchSingleDeliveryExtraDetails({id: this.props.deliveryId});
        }
        this.setState({
                ...
                <Col>
                    <Row>
                        <Col md={6} className="mb-4">
                            <h6 className='mb-4'><i className="feather icon-user text-c-green f-20 m-r-5"/> Pickup Info
                            </h6>
                        ...
                        <Col md={6} className="mb-4">
                            <h6 className='mb-4'><i className="feather icon-user text-c-green f-20 m-r-5"/> Receiver
                                Info</h6>
                            <div className="row d-flex align-items-center mb-2">
                                <div className="col-4 text-right">
                                    <h6 className="f-w-300 m-b-0">Name:</h6>
                        ...
                        <Col md={6}>
                            <h6 className='mb-4'><i className="feather icon-users text-c-green f-20 m-r-5"/> Dispatcher
                                Info</h6>
                            <div className="row d-flex align-items-center mb-2">
                                <div className="col-4 text-right">
                                    <h6 className="f-w-300 m-b-0">Name:</h6>
                        ...
                        <Col md={6}>
                            <h6 className='mb-4'><i className="feather icon-briefcase text-c-green f-20 m-r-5"/> Vehicle
                                Info</h6>
                            <div className="row d-flex align-items-center mb-2">
                                <div className="col-4 text-right">
